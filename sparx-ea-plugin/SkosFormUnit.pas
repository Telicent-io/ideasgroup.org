...
begin
  ...
  begin
    skosSession := tSkosSession.Create('');
    ...
    skossession.setPrefLabel(topConcept,rootElem.Name,edit5.text);
...
begin
  ...
  begin
    ...
    skossession.setPrefLabel(childConcept,myHolder.Name,edit5.text);
